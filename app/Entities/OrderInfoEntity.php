...
class OrderInfoEntity
{
    ...
    #[OA\Property(property: 'goodsAmount', description: '', type: 'float')]
    private float $goodsAmount;

    #[OA\Property(property: 'shippingFee', description: '', type: 'float')]
    private float $shippingFee;

    #[OA\Property(property: 'insureFee', description: '', type: 'float')]
    private float $insureFee;

    #[OA\Property(property: 'payFee', description: '', type: 'float')]
    ...
    #[OA\Property(property: 'moneyPaid', description: '', type: 'float')]
    ...
    #[OA\Property(property: 'integralMoney', description: '', type: 'float')]
    private float $integralMoney;

    #[OA\Property(property: 'bonus', description: '', type: 'float')]
    private float $bonus;

    #[OA\Property(property: 'orderAmount', description: '', type: 'float')]
